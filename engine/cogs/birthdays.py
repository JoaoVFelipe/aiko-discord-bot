...
class Birthdays(commands.Cog):
    ...
    # ----- comandos -----
    @commands.command(name="bday_add")
    ...
    @commands.command(name="bday_remove")
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name="bday_list")
    ...
    @commands.command(name="setbdaychannel")
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name="setbdaytime")
    @commands.has_permissions(manage_guild=True)
    ...
    @commands.command(name="birthdays_today")
